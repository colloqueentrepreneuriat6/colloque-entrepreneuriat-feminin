    ...
    <>
      <div className="flex items-center space-x-2">
        ...
        {onEdit && (
          <button
            onClick={onEdit}
            className="p-2 text-secondary-600 hover:text-accent-600 hover:bg-accent-50 rounded-lg transition-all duration-200"
            title="Modifier"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-premium max-w-md w-full p-6 animate-fade-in">
            ...
            <h3 className="text-heading text-lg font-semibold text-secondary-900 text-center mb-2">
              Supprimer la proposition
            </h3>
            
            <p className="text-body text-sm text-secondary-600 text-center mb-6">
